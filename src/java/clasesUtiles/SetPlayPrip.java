 ...
 * @author NMI12906
 */
public class SetPlayPrip implements Serializable{
    ...
    public SetPlayPrip(String core, String dcore) {
        this.core = core;   
        this.dcore = dcore;
    }
    
    public SetPlayPrip(String core, String hdist, String dcore, String dhdist) {
        this.core = core;
        this.hdist = hdist;
        this.dcore = dcore;
        this.dhdist = dhdist;
