 ...
 * @author mgalicia
 */
public class SetPlayMonDispatch implements Serializable{
    String tfechauhora;
    String ttrafico;
    String tlimsup;
    String tliminf;
    ...
    public SetPlayMonDispatch(String tfechauhora, String ttrafico, String tliminf, String tlimsup, String tsigno){
   ...
   public SetPlayMonDispatch(String gfechauhora, Double glimsup, Double gliminf){
        this.gfechauhora=gfechauhora;
        this.glimsup=glimsup;
        this.gliminf=gliminf;
    }

   public SetPlayMonDispatch(String mfechauhora, String mtrafico, String mlimsup, String mliminf, String mdesviacion, String mcore, String mutype, String msigno, String mhdist){
