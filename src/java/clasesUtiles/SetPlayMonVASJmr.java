 ...
 * @author mgalicia
 */
public class SetPlayMonVASJmr implements Serializable{
    String tfechauhora;
    String ttrafico;
    String tlimsup;
    String tliminf;
    ...
    public SetPlayMonVASJmr(String tfechauhora, String ttrafico, String tliminf, String tlimsup, String tsigno){
   ...
   public SetPlayMonVASJmr(String gfechauhora, Double glimsup, Double gliminf){
        this.gfechauhora=gfechauhora;
        this.glimsup=glimsup;
        this.gliminf=gliminf;
    }

   public SetPlayMonVASJmr(String mfechauhora, String mtrafico, String mlimsup, String mliminf, String mdesviacion, String moperador, String mutype, String msigno, String mhdist){
