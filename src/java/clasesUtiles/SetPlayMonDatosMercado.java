 ...
 * @author NMI16991
 */
public class SetPlayMonDatosMercado implements Serializable{
    String mercado;
    String hora;
    String minutos;
    String llamadas;
    ...
    public SetPlayMonDatosMercado (String mercado, String hora, String minutos, String llamadas, String latitud, String longitud){
    ...
    public  SetPlayMonDatosMercado (String tfecha, String tdia, String tliminf, String tlimsup, String tsigno){
        //System.out.println("Entra setplay:"+tsigno);
        this.tfecha=tfecha;
        this.tdia=tdia;
