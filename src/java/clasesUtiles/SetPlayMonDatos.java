 ...
 * @author mgalicia
 */
public class SetPlayMonDatos implements Serializable{
    String tfechauhora;
    String ttrafico;
    String tlimsup;
    String tliminf;
    ...
    public SetPlayMonDatos(String tfechauhora, String ttrafico, String tliminf, String tlimsup, String tsigno){
   ...
   public SetPlayMonDatos(String gfechauhora, Double glimsup, Double gliminf){
        this.gfechauhora=gfechauhora;
        this.glimsup=glimsup;
        this.gliminf=gliminf;
    }

   public SetPlayMonDatos(String mfechauhora, String mtrafico, String mlimsup, String mliminf, String mdesviacion, String mcore, String mutype, String msigno, String mapn,String mrgroup){
    ...
    public void setMrgroup(String mrgroup) {
        this.mrgroup = mrgroup;
    }
