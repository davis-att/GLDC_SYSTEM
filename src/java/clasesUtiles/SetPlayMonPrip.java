 ...
 * @author mgalicia
 */
public class SetPlayMonPrip implements Serializable{
    String tfechauhora;
    String ttrafico;
    String tlimsup;
    String tliminf;
    ...
    public SetPlayMonPrip(String tfechauhora, String ttrafico, String tliminf, String tlimsup, String tsigno){
   ...
   public SetPlayMonPrip(String gfechauhora, Double glimsup, Double gliminf){
        this.gfechauhora=gfechauhora;
        this.glimsup=glimsup;
        this.gliminf=gliminf;
    }

   public SetPlayMonPrip(String mfechauhora, String mtrafico, String mlimsup, String mliminf, String mdesviacion, String mcore, String mutype, String msigno, String mhdist){
